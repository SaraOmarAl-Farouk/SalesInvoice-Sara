 ...
 * @Sara Gharieb
*/
import sales.controller.Listener;
...
public class InvoiceFrame extends javax.swing.JFrame {
    ...
    private HeaderTable_Invoice invoicesTableModel;
    
    

    public ArrayList<Header_Invoice> getInvoices() {
        if (invoices == null) invoices = new ArrayList<>();
        return invoices;
    }

    public void setInvoices(ArrayList<Header_Invoice> invoices) {
        this.invoices = invoices;
    }
    
     public HeaderTable_Invoice getInvoicesTableModel() {
         if (invoicesTableModel == null) {
            invoicesTableModel = new HeaderTable_Invoice(getInvoices());
        }
        return invoicesTableModel;
    }

    public void setInvoicesTableModel(HeaderTable_Invoice invoicesTableModel) {
    ...
    public Listener getController() {
     ...
     public int getNextInvoiceNum() {
        ...
        for (Header_Invoice invoice : getInvoices()) {
